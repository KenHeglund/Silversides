...
class OBWFilteringMenuScrollTracking {
	...
	///
	/// - Parameters:
	///   - totalMenuItemSize: The size of all menu items.
	///   - initialBounds: The initial visible area of the menu item view.
	///   - finalBounds: The maximum visible area of the menu item view.
	...
	///
	/// - parameter rawEvent: The event to handle.
	...
	/// An enum to describe which ends of a menu are being clipped by the top or
	...
	/// An enum to describe how the menu is currently responding to scroll
	/// events.
	private enum ScrollTrackingAction {
		/// The content of the menu is scrolling.
		case scrolling
		/// The content has scrolled up as far as possible and is being
		/// stretched upward.
		case bottomStretch
		/// The content has scroll down as far as possible and is being
		/// stretched downward.
		case topStretch
	...
	/// 
	/// - Parameter notification: The notification posted when the bounds of the
	/// small scroll view changes.
	...
	private var previousScrollEvent: NSEvent?
	
	/// Clamps the scroll magnitude of the given event to a reasonable
	/// magnitude.
	///
	/// - Parameter sourceEvent: A scroll wheel event.
	///
	/// - Returns: Returns the original event if the scroll magnitude is
	/// acceptable.  Otherwise, creates a new event.
...
extension OBWFilteringMenuScrollTracking {
	...
	/// - parameter userInfo: value - An `NSRect` containing the new menu item
	/// bounds.
